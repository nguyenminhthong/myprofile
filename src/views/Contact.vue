                ...
                <div class="container">
                    ...
                    <div class="row contact-info">
                        <div class="col-lg-4 mt-5">
                            <div class="text-center">
                                <div class="base-color">
                                    <img src="images/img-phone.svg" alt=""></div>
                                <div class="mt-3">
                        ...
                        <div class="col-lg-4 mt-5">
                            <div class="text-center">
                                <div class="base-color">
                                    <img src="images/img-location.svg" alt=""></div>
                                <div class="mt-3">
                        ...
                        <div class="col-lg-4 mt-5">
                            <div class="text-center">
                                <div class="base-color">
                                    <img src="images/img-send.svg" alt=""></div>
                                <div class="mt-3">
                                    <h5 class="text-dark mb-0">Email Us At</h5>
                                    <small class="text-muted"><a href="email-protection.html" class="__cf_email__"
                                            data-cfemail="d3b2b1b093b4beb2babffdb0bcbe">[email&nbsp;protected]</a></small>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-sm-12 mt-4 text-left">
                                        <div class="button-border">
                                            <a href="javascript:void(0)" class="pill-button" id="submit-btn"
                                                onclick="sendEmail()">Send Message</a>
                                        </div>
                    ...
                    <div class="row copy-right">
                        <div class="col-12 text-center">
                            <p>Copyright &copy; 2019. Template has been designed by <span
                                    class="base-color">Retrina</span></p>
                        </div>
                    </div>
                </div>
            </div>
